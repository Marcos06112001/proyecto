...
/* la tabla de PROMOCIONES*/
create table DB_PROYECTO_DWP_2.TAB_PROMOCIONES(
  COD_PROMOCION INT auto_increment,
  DES_PROMOCION VARCHAR(2048),
  FEC_INICIO DATE,
  FEC_FIN DATE,
  DESCUENTO INT,
...
/* la tabla de RETROALIMENTACION*/
create table DB_PROYECTO_DWP_2.TAB_RETROALIMENTACION(
  CORREO VARCHAR(30),
  COD_RETROALIMENTACION INT auto_increment,
  COMENTARIO VARCHAR(2048),
  VALORACION INT,
  PRIMARY KEY (COD_RETROALIMENTACION),
  FOREIGN KEY (CORREO) REFERENCES DB_PROYECTO_DWP_2.TAB_USUARIOS(CORREO)
)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
