  ...
  <div class="container">
    ...
    <div class="row">
      ...
      $designs = [
          ...
          [
            "id_diseno" => 5,
            "nom_diseno" => "Pulsera de piedras peque as",
            "des_diseno" => "Una pulsera de un color con piedras peque as cone lastico",
            "tipo_diseno" => "B",
          ...
          <div class="col-md-4 mb-3">
            <div class="card p-2 m-2">
              <figure>
                ...
                <figcaption>
                  <span class="text-success">Tipo de diseño</span>
                </figcaption>
              </figure>
    ...
    <!-- Agregar más tarjetas deproducto según sea necesario -->
  </div>
</section>
