                            ...
                            <div class="mt-5" style="padding-left: 15%;padding-right: 15%">
                                ...
                                <th:block th:unless="${comentarios.empty}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" readonly="readonly" name="txtDesc" rows="10" style="border-radius: 20px; height: 350px" th:text="${comentarios[0].comentario}"></textarea>
                                    </div>
                        ...
                        <form th:action="@{/foro/guardar}" th:object="${foro}"
                            ...
                            <div class="card-body">
                                <div class="m-5">
                                    <div class="mb-3">
                                        <label  for="txtNombre">Nombre que comenta:</label>
                                        <input type="text" class="form-control" name="txtNombre" th:value="${usuario.nombre + ' ' + usuario.apellido1 + ' ' + usuario.apellido2}" style="border-radius: 20px;"/>
                                    </div>
                                    <div class="mb-3">
                                        <label for="txtDesc">Descripcion del Comentario:</label>
